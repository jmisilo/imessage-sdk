...
import { createIMessageClient, ValidationError } from "../src/index.js";
...
describe("Blooio provider", () => {
  it("sends text, public attachments, replies, and idempotency keys", async () => {
    ...
    expect(url).toBe(
      "https://api.blooio.com/v2/api/chats/%2B15551111111/messages",
    );
    ...
    expect(JSON.parse(String(init?.body))).toEqual({
      text: "Hello",
      attachments: [
        { url: "https://cdn.test/photo.jpg", name: "photo.jpg" },
      ],
